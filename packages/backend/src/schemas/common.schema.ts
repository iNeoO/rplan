...
export const createPaginationQuerySchema = <T extends string>(
...
export type PaginationQueryPayload<T extends string> = Z.infer<
  ReturnType<typeof createPaginationQuerySchema<T>>
>;
...
export const stringToNestedObject = (
  string: string,
  order: 'asc' | 'desc',
): stringToNestedObjectReturn => {
