...
import { createPlan, formatPlan, formatPlans, getPlans } from '../services/plan.service.ts';

import { GetPlanReturnSchema, GetPlansReturnSchema, PostPlanDtoSchema } from '../schemas/plan.schema.ts';

import { ErrorSchema } from '../schemas/error.schema.ts';

const app = createInternalApp<{ Variables: AuthVariables }>().basePath('/plan');
