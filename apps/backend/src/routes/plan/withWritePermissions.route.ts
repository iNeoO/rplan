...
import {
  InvitationByEmailSchema,
  InvitationByLinkSchema,
...
import { PermissionsReturnSchema, permissionsColumns } from '../../schemas/userWithPermission.schema.ts';
...
import { createInvitationByEmail, createInvitationByLink, invitations } from '../../services/invitation.service.ts';
...
const inviteUserByEmail = createRoute({
  ...
  responses: {
    200: {
      ...
      content: {
        'application/json': {
          schema: InvitationByEmailSchema,
        },
      },
    },
    400: {
